...
from apps.views.user import (MainTemplateView, ProfileTemplateView,
                             ...
                             LoginFormView, UpdateViewProfile,
                             ConfirmMailTemplateView, ForgetPasswordTemplateView,
                             LockScreenTemplateView, LogoutRedirectView,
                             ResetPasswordTemplateView, RegisterCreateView)
